...
**Svar:** Det är inte fel att träda in i *ihrām[^1]* innan platsen för *mīqāt[^2]*. Det är som om du går in i *ihrām[^1]* vid at-Ta'if genom att rena dig själv, ta på *ihrām[^1]*-kläder, utforma avsikten och säga *talbiyyah[^3]*. Invånarna i Medina får träda in i *ihrām[^1]* i sina hem. På samma sätt så får invånarna i Egypten, om de avser att resa, träda in i *ihrām[^1]* när de kommer ut från deras hem eller när de befinner sig i flygplanet på väg mot Jiddah. Detta är dock i motsats till det som är att föredra.
