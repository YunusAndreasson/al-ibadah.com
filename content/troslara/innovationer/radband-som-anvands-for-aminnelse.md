...
**Svar:** Det är bättre att använda sina fingrar för åminnelse[^1] och det är bättre att enbart använda högerhanden när man gör så i stället för att både använda den högra och den vänstra. Detta är vad som har rapporterats från profetens *sunnah* – över honom vare Allāhs frid och välsignelser. Han beordrade att åminnelse[^1] och *tasbih* ska räknas på fingrarna. Han har sagt att de kommer att tillfrågas om det och han åmindes med hjälp av sin högra hand. Att använda radband innebär vissa överträdelser:
