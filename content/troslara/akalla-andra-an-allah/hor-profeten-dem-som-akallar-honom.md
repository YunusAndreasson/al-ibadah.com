...
Det finns även en *hadīth*[^2] som Abu Dawūd har nedtecknat med en rapportörskedja som är hasan från Abu Hurairah: ”*När någon hälsar till mig så återlämnar Allāh min själ till mig så att jag kan hälsa tillbaka*.” [^5] Den visar inte tydligt att han hör den som hälsar till honom. I stället kan det vara så att profeten besvarar hälsningen när änglarna förmedlar den till honom. Även om vi antar att han hör hälsningen så betyder det inte nödvändigtvis att han hör åkallan[^1] eller annat som sägs.
