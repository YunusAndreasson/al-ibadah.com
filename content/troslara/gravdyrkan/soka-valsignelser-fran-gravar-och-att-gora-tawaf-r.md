...
Trodde den som sökte välsignelser att gravens invånare hade någon inverkan eller förmåga att skydda mot ont eller ge något gott, då är det stor *s̲hirk* om personen åkallade dem i något av dessa syften. Det är också stor *s̲hirk* om den som residerar i graven dyrkas genom bugningar, nedfallanden eller slakt av ett djur för att komma närmare och visa vördnad för personen. Allāh den Upphöjde säger:
...
Det är inte tillåtet att som bevis för denna felaktiga handling säga att föräldrarna gjorde det eller att det är en vana. Argumenterar någon på detta sätt är personens argument ogiltigt hos Allāh den Upphöjde och det kommer inte att göra personen någon nytta.
