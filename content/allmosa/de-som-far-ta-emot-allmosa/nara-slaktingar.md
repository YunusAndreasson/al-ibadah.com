...
På liknande sätt är det om det finns nära släktingar som inte behöver allmosa för finansiellt stöd, men som har skulder, då är det tillåtet att ordna upp deras skulder även om släktingen är en far, son, dotter eller mor så länge skulden som de har inte beror på ett otillräckligt [ekonomiskt] stöd.

Ett exempel på detta skulle vara en man vars son har varit inblandad i en olycka och som var skyldig att betala för skadorna på bilen han krockade, och som inte hade några pengar. I detta fall skulle det vara tillåtet om fadern betalade skadorna, som sonen måste stå för, genom allmosa [från faderns allmosa]. Detta beror på att fadern inte är skyldig att betala dessa skador som en del av sitt finansiella stöd. I stället är det en skyldighet som åligger honom på grund av något som inte har med finansiellt stöd att göra.
