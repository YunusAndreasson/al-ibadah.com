...
source: >-
  ...
  Libanon: Makbtaba Dar us-Salam. 338 s. ISBN 9960-892-66-2
categories:
  - Renhet (Tahārah)
...
Vissa lärde säger att på grund av deras svaghet så kan de inte användas. Dessa lärde är själva oeniga. Några säger att det inte är nödvändigt att rena *jabirah* då det inte är möjligt att göra det. Andra säger att man bör göra *tayammum* där och inte stryka över det.

Men det närmaste vad som sagts om dessa utlåtanden, oberoende av de *aḥādīt̲h* som återberättats i detta ämne, är att man ska stryka över. Denna strykning är tillräcklig utan *tayammum* som det inte finns något behov för. Därför säger vi att om det finns ett sår på en kroppsdel som måste renas, då kommer detta att hamna i en av följande kategorier:
