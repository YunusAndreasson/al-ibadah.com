...
description: 'Fråga: Om man tar av sina sockar medan man fortfarande är rituellt
 ...
 då stryka över dem? Svar: Tar man av sina soc...'
---

**Fråga:** Om man tar av sina sockar medan man fortfarande är rituellt ren och byter dem [mot ett annat par] innan ens tvagning[^1] blir ogiltig – kan man då stryka över dem?

**Svar:** Tar man av sina sockar och byter dem medan ens tvagning[^1] fortfarande är giltig, då gäller ett av följande scenarion:

1. Att denna tvagning[^1] är den första, det vill säga att den inte har hunnit bli ogiltig efter att man har tagit på dem [sockarna]. I detta fall finns det ingen invändan mot att man stryker över dem när man tvagar sig.
2. Om denna tvagning[^1] var en då man strök över sockarna, då är det inte tillåtet om man har tagit av dem att byta dem och stryka över dem [det nya paret]. Detta beror på att de måste tas på när man blivit rituellt ren genom vatten och här blev man ju ren genom att stryka. Detta är inget som är känt från de lärdas uttalanden.
