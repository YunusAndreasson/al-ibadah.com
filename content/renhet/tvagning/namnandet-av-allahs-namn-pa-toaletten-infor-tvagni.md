...
description: 'Fråga: När jag vill tvaga mig utformar jag avsikten för att tvaga inför
 bönen. Jag nämner dock inte Allāhs namn då jag jag är på toaletten, även om jag
 känner till denna hadīth : ”Det finns ingen...'
---

**Fråga:** När jag vill tvaga mig utformar jag avsikten för att tvaga inför bönen. Jag nämner dock inte Allāhs namn då jag jag är på toaletten, även om jag känner till denna *hadīth[^1]*: ”Det finns ingen tvagning[^2] för den som inte har nämnt Allāhs namn vid den.” Vilket är utlåtandet om detta?
