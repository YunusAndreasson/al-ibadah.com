---
title: Osäker på sin förra tvagning
...
description: 'Fråga: En man tvagade sig och lade sedan märke till en fläck på foten.
 ...
 sig korrekt. Vad bör han göra? Svar: Flä...'
---
...
**Svar:** Fläcken på foten som frågeställaren har lagt märke till, och som han tror att vattnet inte nådde en eller två gånger när han tvagade[^1] sig, betyder inte att den inte är giltig. Grundprincipen är ju – om Allāh vill – att han har utfört sin tvagning[^1] korrekt. Denna princip ändras inte på grund av tveksamheter. Detsamma gäller *ghusl[^2]* efter den stora orenheten. Grundprincipen säger att den är giltig och att han inte behöver göra om bönen.
