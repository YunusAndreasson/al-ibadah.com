...
**Svar:** Autentiska *ahādīth* från Allāhs sändebud, likt de från Sahl bin Sa'd, Wa'il bin Hujr och andra, visar att Allāhs tjänare får lägga höger hand över den vänstra när han har rest sig upp från bugningen[^1]. Detta gäller både för momenten där han står innan bugningen[^1] och när han har rest sig upp från den. I vissa av *hadītherna*[^2] finns det bevis för att det är bättre att lägga dem på bröstet. Enligt de autentiska *ahādīth* som har nämnts tidigare är detta något som man har valmöjlighet att göra.
