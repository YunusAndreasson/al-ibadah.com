...
description: 'Fråga: Jag har noterat att vissa imamer – må Allāh vägleda dem – förlänger
 ...
 grund för att ändra röstläget för at...'
---

**Fråga:** Jag har noterat att vissa imamer – må Allāh vägleda dem – förlänger det sista nedfallandet[^1] i bönen. Tillåter den islamiska lagen detta? Finns det någon grund för att ändra röstläget för att folk skall veta att man skall sitta och göra *tashahhud[^2]*?

**Svar:** Jag känner inte till något bevis som stödjer att det sista nedfallandet[^1] skall förlängas. I *ahādīth[^3]* har det endast rapporterats att nedfallandena skall vara lika eller ungefär lika långa.

Att ändra röstens tonläge när man säger *takbīr[^4]* inför en sittning är välkänt bland imamerna. Det kan vara så att deras bevis är att det är en sed som har ärvts genom åren. Det är ju inte något som har kunnat skrivas ned utan det måste överföras genom handling. En nytta uppnås genom detta då Allāhs tjänare informeras om att de skall sitta för *tashahhud[^2]* och de undviker att stå upp efter *takbīr[^4]*.
