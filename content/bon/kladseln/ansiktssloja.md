...
**Svar:** Om en kvinna ber i sitt hem på en plats där ingen kan se henne utom de som är hennes *mahram[^1]*, då får hon visa ansiktet och händerna för att hennes panna och näsa skall komma i direktkontakt med platsen för nedfallan[^2] [på marken]. Detsamma gäller hennes händer.

Men om hon ber där det finns män omkring henne som inte är hennes *mahram[^1]*, då måste hon täcka ansiktet. Detta beror på att det är en skyldighet att täcka ansiktet inför dem som inte är *mahram[^1]*. Det är inte tillåtet att visa det för dem. Detta bevisas genom Allāhs den Härliges, den Upphöjdes skrift, Hans sändebuds *sunnah[^3]* och den korrekta åsikten som inget förnuftigt sinne kan förneka, inte minst en troendes.
...
Ansiktet döljer hon medan hon sitter och står. När hon sedan vill nedfalla[^2] avtäcker hon det för att det skall få direktkontakt med platsen för nedfallan[^2].
