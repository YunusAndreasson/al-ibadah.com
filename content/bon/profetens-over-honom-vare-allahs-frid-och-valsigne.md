...
2. Skyldigheten att vända sig i denna riktning gäller inte för den som befinner sig i en krigssituation eller strider intensivt när denne ber rädslebönen[^1]. Det gäller heller inte för den som inte har möjlighet att göra det; likt den som är sjuk eller någon som färdas i ett fartyg, en bil eller ett plan om denne är rädd för att tiden kommer att rinna ut [innan denne når en plats där denne kan finna den korrekta riktningen]. Det gäller heller inte den som ber en bön som är frivillig eller *witr[^2]* när denne befinner sig på ett riddjur eller liknande, men det är rekommenderat att denne vänder sig mot *qiblah[^3]* om denne har möjlighet att göra så när denne uttalar *takbīr[^4]* i början av bönen. Därefter kan denne vara vänd i vilken riktning som helst.
...
1. Ber någon utan att vara vänd mot *qiblah[^3]*, med anledning av moln [som inte låter denne ta reda på riktningen från solens position] eller någon annan anledning, efter att denne har gjort sitt bästa för att ta reda på den rätta riktningen, då är dennes bön giltig och den behöver inte upprepas.
...
1. Det är obligatoriskt att be stående. Detta är en pelare [väsentlig del av bönen] utom för den som ber rädslebönen[^1] eller när intensiva strider pågår, då är det tillåtet att be under ritt; som är sjuk och inte har möjlighet att stå, som bör be sittande om denne har möjlighet annars liggandes på sin sida; som ber en frivillig bön, som får bes när denne rider eller sitter och denne markerar bugningen[^5] och nedfallandet[^6] med huvudet. Den som är sjuk får också göra detta och denne gör nedfallan[^6] lägre än bugningen[^5].
2. Den som ber sittande får inte placera något upprest på marken för att nedfalla mot det. Som vi har nämnt bör denne i stället göra nedfallan[^6] lägre än bugningen[^5] om denne inte har möjlighet att röra marken direkt med sin panna.
...
1. Det är tillåtet att utan ursäkt be nattbön stående eller sittande, eller att göra både och. Man kan be och recitera sittande och precis före man bugar kan man stå upp och recitera de resterande verserna ståendes, sedan buga och nedfalla[^6] och därefter göra på samma sätt i den andra bönecykeln[^7].
...
2. Det är bättre att ibland be barfota och att ibland bära skor enligt vad som är smidigast. Man skall inte göra det svårt och ta på eller av skor för att be. Är man barfota bör man be barfota och bär man skor bör man be i skor, utom om det finns en anledning till att inte göra så.
...
1. Imamen får be från en upprest plats, som talarstolen, för att lära folket. Så han bör stå upp på den och be, sedan säga *takbīr[^4]*, recitera Koranen och buga när han befinner sig på den platsen, sedan bör han gå ned så att han kan nedfalla[^6] på marken vid talarstolens fot och sedan kan han ställa sig på den igen och göra samma sak i den andra bönecykeln[^7] som han gjorde i den första.

Det är obligatoriskt att be i riktning mot och vara nära en *sutrah[^8]*
...
1. En *sutrah[^8]* är så viktig för bönen att den hindrar att bönen blir ogiltig om någon passerar framför. Detta står i motsats till den som inte använder en *sutrah[^8]*, vars bön bryts om en mogen kvinna, en åsna eller en svart hund passerar framför.

***Niyyah*** **[intention]**

1. Den som ber måste ha avsikt att be bönen som denne står [för att be]. Denne måste ha avsikt i sitt hjärta för att förrätta en specifik bön, som den obligatoriska bönen förmiddagsbönen[^10] eller för eftermiddagsbönen[^11]; eller *sunnah[^12]* för dessa böner. Detta är ett krav eller en pelare [väsentlig del] i bönen. Att uttala avsikten med ord är dock en innovation som går emot profetens – över honom vare Allāhs frid och välsignelser – *sunnah[^12]*. Detta har inte föreslagits av någon av imamerna som vi följer.
...
1. Man bör höja sina händer före, efter eller när man säger *takbīr[^4]*. Dessa sätt finns det bevis för i profetens – över honom vare Allāhs frid och välsignelser – *sunnah[^12]*.
2. Man bör höja dem med sina fingrar utsträckta.
3. Man bör höja dem i nivå med sina axlar eller ibland tills dem är i nivå med örsnibbarna. Att röra örsnibbarna med tummarna finns det ingen grund för i profetens – över honom vare Allāhs frid och välsignelser – *sunnah[^12]*. Enligt min mening har detta i stället att göra med *waswās*.

Var händerna skall placeras

1. Direkt efter *takbīr[^4]* placerar man sin högra hand över den vänstra. Detta är profetens – över honom vare Allāhs frid och välsignelser – sätt och vad han påbjöd följeslagarna. Det är inte tillåtet att låta armarna hänga längs sidorna.
...
Ödmjukhet och att titta på platsen för nedfallan[^6]
...
4. Därefter säger man tyst – oberoende av om bönen skall reciteras högt eller lågt - ”*Bismillah[^15] il-Rahmān il-Rahīm* [I Allāhs, den Nåderikes, den Barmhärtiges Namn].”
...
1. Det är *sunnah[^12]* är att recitera Koranen med väl avvägda mått; varken snabbt eller hastigt. Koranen bör läsas på ett sätt som tydligt skiljer varje bokstav åt och som med röstens hjälp gör den vacker. Man bör iaktta de välkända reglerna från de lärda inom *tajwīd[^21]* och man bör inte recitera den på ett felaktigt sätt [som har förts in i religionen], som genom sång eller enligt regler som hör musik till.
...
2. Därefter höjer man sina händer på det sätt som har beskrivits för *takbīr[^4]* vid inledningen av bönen.
3. Man säger *takbīr[^4]*. Detta är obligatoriskt.
...
1. Det är *sunnah[^12]* att göra de viktiga delarna av bönen lika i längd så att bugningen[^5], när man står [rakt upp] efter bugningen[^5], nedfallandet[^6] och när man sitter mellan de båda nedfallandena ungefär lika långa.
2. Det är inte tillåtet att recitera koranen i bugningen[^5] eller i nedfallandet[^6].
...
12. Man skall se till att tårna pekar i riktning mot *qiblah[^3]*.
13. Hälarna för man samman.

Lugn i nedfallan

1. I nedfallan[^6] är man avslappnad med sin vikt likvärdigt fördelad över alla kroppsdelar som skall vara i kontakt med marken under nedfallan. Dessa är: näsan, pannan, handflatorna, knäna och tårna.
...
7. Det är inte tillåtet att recitera Koranen under nedfallandet[^6].
...
6. Man ser till att tårna pekar mot *qiblah[^3]*.
...
10. Sittandet gör man nästan lika långt som sin nedfallan[^6].
...
1. När han reser sitt huvud ifrån den andra nedfallandet[^6] och man vill gå upp för den andra bönecykeln[^7], då säger man *takbīr[^4]*. Detta är obligatoriskt.
2. Ibland bör man höja sina händer.
...
1. När man har utfört den andra bönecykeln[^7] bör man sitta i *tashahhud[^23]*. Detta är obligatoriskt.
2. Man sitter i *iftirāsh* på så vis som har beskrivits ovan för sittandet mellan de båda nedfallandena[^6].
...
3. Pekfinger pekar man mot *qiblah[^3]*.
4. Man tittar mot det.
5. Man rör det, åkallar[^14] med det, från början till slutet av *tashahhud[^23]*.
6. Man pekar inte med vänstra handens finger.
7. Detta gör man i varje *tashahhud[^23]*.

Hur man säger *tashahhud[^23]* och den efterföljande åkallan[^14]
...
1. Sedan säger han *takbīr[^4]*, vilket är obligatoriskt. Det är *sunnah[^12]* att säga *takbīr[^4]* samtidigt som man sitter.
2. Ibland bör man höja sina händer.
3. Därefter reser man sig för en tredje bönecykel, vilken är en väsentlig del av bönen, precis som den följande bönecykeln[^7].
...
1. Det är *sunnah[^12]* att recitera *qunūt[^24]* och be för muslimerna när någon katastrof drabbar dem.
...
3. Det finns ingen specifik åkallan[^14] som vanligtvis bör reciteras i *qunūt[^24]*, i stället reciterar man något som är lämpligt när stora svårigheter inträffar.
4. När man reciterar denna åkallan[^14] höjer man sina händer.
5. Är man imam reciterar man den högt.
6. De som ber bakom säger ”*āmīn*” för denna åkallan[^14].
7. När man har avslutat säger man *takbīr[^4]* och nedfaller.

*Qunūt al-witr[^2]* – när den skall reciteras och vad den bör innehålla

1. *Qunūt* i *witr[^2]* är föreskriven någon gång då och då.
2. Den reciteras före bugningen, olikt *qunūt[^24]* som reciteras under stora svårigheter.
...
4. Denna åkallan[^14] har Allāhs sändebud – över honom vare Allāhs frid och välsignelser – lärt ut så den är tillåten då den har återberättats från hans följeslagare.
5. Sedan bugar[^5] man och nedfaller[^6] två gånger som tidigare.

Den sista *tashahhud[^23]* och placerandet av den vänstra foten under det högra benet

1. Sedan sitter man för den sista *tashahhud[^23]*.
2. Man gör på samma sätt som i den första *tashahhud[^23]*.
...
1. I denna *tashahhud[^23]* måste man sända välsignelser över profeten. Några versioner har vi citerat ovan när vi diskuterade den första *tashahhud[^23]*.
...
1. Sedan kan man åkalla för sig själv på passande sätt, enligt vad som finns återberättat i Koranen och profetens – över honom vare Allāhs frid och välsignelser – *sunnah[^12]*. Det finns många sådana bra åkallan[^14] den. Känner man inte till någon sådan åkallan[^14] kan man säga något som är lätt för en, för saker som kommer att göra en nytta i ens religion och världsliga förehavanden.

Olika former av *taslīm[^13]* [säga *salām*]
...
Min muslimska broder, detta är vad jag har kunnat sammanställa från *Sifat Salāt al-Nabi* [*The Prophet's Prayer Described*] i ett försök att göra den mer lättillgänglig för dig [och] för att den skall bli tydlig för dig, som om jag såg dig med mina egna ögon. Om du ber på det sätt som beskrivits för dig om hur profeten – över honom vare Allāhs frid och välsignelser – bad, då hoppas jag att Allāh kommer att acceptera detta ifrån dig, för genom att göra på detta sätt har du sannerligen satt profetens – över honom vare Allāhs frid och välsignelser – ord i praktik: ”*Be som ni har sett mig be*.”
...
[^7]: Rakah.
[^8]: Ett objekt i form av exempelvis en pinne, stav eller vägg. Skall vara minst en fot hög. Agerar symbolisk skiljelinje mellan den bedjande och de som passerar framför.
[^9]: Avser oftast ett uttalande från profeten - över honom vare Allahs frid och välsignelser. Tjänar som en förklaring av Koranen.
[^10]: Dhuhr
[^11]: Asr
...
[^14]: Du´ā
[^15]: I Guds namn.
[^16]: Att säga Bismillah.
[^17]: Levande väsen skapade av eld. De kan se oss men vi människor kan inte se dem.
[^18]: Fajr
[^19]: Isha
[^20]: Maghrib
[^21]: Regler som förklarar hur Koranen skall reciteras.
[^22]: Dhikr
