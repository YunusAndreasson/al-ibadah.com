...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: 'stylesheet',
        href: 'https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Source+Serif+4:ital,opsz,wght@0,8..60,400;0,8..60,600;0,8..60,700;1,8..60,400&family=Amiri:ital,wght@0,400;0,700;1,400&display=swap',
      },
    ],
    scripts: [
