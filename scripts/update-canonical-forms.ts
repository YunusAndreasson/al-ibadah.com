...
const PROPER: Record<string, string> = {
  ...
  'adhan': `ad${U}hān`,
  'khushu': `k${U}hus${U}hū\u00B4`,
  'qiyam al-layl': 'qiyām al-layl',
  'salat al-janazah': 'ṣalāt al-janāzah',
  'salat al-jumuah': 'ṣalāt al-jumu\u00B4ah',
  'salat al-id': 'ṣalāt al-\u00B4īd',
  // purificationTerms
  'ghusl': `g${U}husl`,
  'tayammum': 'tayammum',
  'wudu': 'wuḍū\u2019',
  ...
  'rafidi': 'rāfiḍī',
  'mujahidin': 'mujāhidīn',
  'khawarij': `k${U}hawārij`,
  'mutazilah': 'mu\u00B4tazilah',
  'zaydi': 'zaydī',
  'ithna ashriyyah': `It${U}hnā \u00B4As${U}hriyyah`,
  'ahl al-hadith': `ahl al-ḥadīt${U}h`,
  // tawhidTerms
